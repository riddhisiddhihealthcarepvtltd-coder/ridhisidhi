...
const ContactCard = () => {
  return (
    <div className="bg-[#2e1065] text-white rounded-2xl p-6 sm:p-10 shadow-xl border border-white/10 space-y-8">
      <div>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <a href={`mailto:${companyInfo.email}`} className="font-sans text-[13px] sm:text-base font-bold text-white block hover:text-[#f3e8ff] transition-colors break-all sm:break-normal leading-snug mt-0.5">
              {companyInfo.email}
            </a>
          </div>
        </div>
